...
\caption{\textbf{V-JEPA~2 linear probe results.} A single linear layer trained on frozen V-JEPA features can predict object XY position (R$^2$=0.77), object size (R$^2$=0.82), and object class (85\% accuracy) far above random baselines.}
\label{fig:probe}
\end{figure}
